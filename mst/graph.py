...
class Graph:
    ...
    def construct_mst(self):
        ...
        """
        num_vertices = dist_mat.shape[0] #pick one of the 2 dimensions of the symmetric matrix to get the # of vertices
        ...
        def add_edges_to_pq(pq,start_node):
            ...
            for neighbor in np.argwhere(dist_mat[start_node]>0):#find neighboring nodes of start node by finding what other nodes form an edge of weight >0 with the start node.
                ...
                heapq.heappush(priority_queue,(dist_mat[start_node,neighbor],start_node,neighbor)) #add tuple to priority_queue with form (weight,visited_node_idx,neighbor_idx)
